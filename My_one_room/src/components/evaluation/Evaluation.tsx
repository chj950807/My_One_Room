  ...
  return (
    <div className="min-w-full">
      <form>
        ...
        <div>
          <textarea className="bg-gray-100 border border-black rounded-lg w-full h-20"></textarea>
        </div>
        <div className="mt-10">
          <button className="btn btn-wide btn-primary text-lg" type="submit">작성완료</button>
        </div>
      </form>
    </div>
  );
